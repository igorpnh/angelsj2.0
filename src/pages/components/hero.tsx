...
export default function Hero() {
  ...
  const confetti = {
    light: {
      primary: "ED64A6", // blue.400
      secondary: "FED7E2", // blue.100
    },

    dark: {
      primary: "521B41", // blue.900
      secondary: "702459", // blue.800
    },
  };
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Text color={"gray.500"}>
            Consulte nosso catálogo para verificar as coleções e as
            disponibilidades
          </Text>
          <Stack
            direction={"column"}
